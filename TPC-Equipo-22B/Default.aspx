        ...
        <div class="row">
            <div class="col-12 categoria categoria-principal">
                <div class="categoria__caja categoria__caja--principal">
                    ...
                    <a class="categoria__boton categoria__boton--principal" href="filtros.aspx?categoriaId=<%: ListaCategoria[0].Id %>">Ver Categorías</a>
        ...
        <div class="row fila">
            <div class="col-3 categoria categoria-uno">
                <div class="categoria__caja categoria__caja--uno">
                    ...
                    <a class="categoria__boton categoria__boton--uno" href="filtros.aspx?categoriaId=<%: ListaCategoria[1].Id %>">Browse</a>
            ...
            <div class="col-3 categoria categoria-dos">
                <div class="categoria__caja categoria__caja--dos">
                    ...
                    <a class="categoria__boton categoria__boton--dos" href="filtros.aspx?categoriaId=<%: ListaCategoria[2].Id %>">Browse</a>
            ...
            <div class="col-6 categoria categoria-tres">
                <div class="categoria__caja categoria__caja--tres">
                    ...
                    <a class="categoria__boton categoria__boton--tres" href="filtros.aspx?categoriaId=<%: ListaCategoria[3].Id %>">Browse</a>
        ...
        <div class="row fila">
            <div class="col-6 categoria categoria-tres">
                <div class="categoria__caja categoria__caja--cuatro">
                    ...
                    <a class="categoria__boton categoria__boton--cuatro" href="filtros.aspx?categoriaId=<%: ListaCategoria[4].Id %>">Browse</a>
            ...
            <div class="col-3 categoria categoria-uno">
                <div class="categoria__caja categoria__caja--cinco">
                    ...
                    <a class="categoria__boton categoria__boton--cinco" href="filtros.aspx?categoriaId=<%: ListaCategoria[5].Id %>">Browse</a>
            ...
            <div class="col-3 categoria categoria-dos">
                <div class="categoria__caja categoria__caja--seis">
                    ...
                    <a class="categoria__boton categoria__boton--seis" href="filtros.aspx?categoriaId=<%: ListaCategoria[6].Id %>">Browse</a>
