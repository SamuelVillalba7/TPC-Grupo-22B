...
insert into CATEGORIAS (NOMBRE,URLIMAGEN,VISIBLE) values ('Auriculares','https://localhost:44317/img/productos/auricular.png',1)
insert into CATEGORIAS (NOMBRE,URLIMAGEN,VISIBLE) values ('Celulares','https://localhost:44317/img/productos/celular.png',1)
insert into CATEGORIAS (NOMBRE,URLIMAGEN,VISIBLE) values ('Monitores','https://localhost:44317/img/productos/monitor.png',1)
insert into CATEGORIAS (NOMBRE,URLIMAGEN,VISIBLE) values ('Parlantes','https://localhost:44317/img/productos/parlante.png',1)
insert into CATEGORIAS (NOMBRE,URLIMAGEN,VISIBLE) values ('Consolas','https://localhost:44317/img/productos/consola.png',1)
insert into CATEGORIAS (NOMBRE,URLIMAGEN,VISIBLE) values ('Relojes','https://localhost:44317/img/productos/reloj.png',1)
insert into CATEGORIAS (NOMBRE,URLIMAGEN,VISIBLE) values ('Mouses','https://localhost:44317/img/productos/mouse.png',1)
...
--SELECT TOP 7 IDCATEGORIA, NOMBRE, UrlImagen, Orden FROM Categorias WHERE VISIBLE=1 AND ESTADO=1 ORDER BY Orden ASC
